      ...
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-24 text-center">
        <ScrollReveal>
          ...
          <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-white/50">
            Grâce à vous, NAKA accélère le déploiement de la logistique
            décarbonée à Lomé. Vous recevrez vos contreparties par email sous 48h.
          </p>
          ...
          <div className="mx-auto mt-12 flex flex-col items-center">
            ...
            <p className="mt-4 text-xs text-white/30">
              Soit {co2Kg.toLocaleString()} kg CO<sub>2</sub> évités
            </p>
          </div>
